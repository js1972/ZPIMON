...
@XmlType(name = "AdapterFilter", propOrder = {
...
public class AdapterFilter {
    ...
    @XmlElementRef(name = "correlationID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "fromTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "messageFormat", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    protected JAXBElement<String> messageFormat;
    @XmlElementRef(name = "messageIDs", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "referenceIDs", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "sequenceID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "statuses", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    protected JAXBElement<ArrayOfString> statuses;
    protected int timesFailed;
    @XmlElementRef(name = "toTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
