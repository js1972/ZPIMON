...
public class Locale {
    ...
    @XmlElementRef(name = "language", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    protected JAXBElement<String> language;
    @XmlElementRef(name = "country", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
    protected JAXBElement<String> country;
    @XmlElementRef(name = "variant", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class)
