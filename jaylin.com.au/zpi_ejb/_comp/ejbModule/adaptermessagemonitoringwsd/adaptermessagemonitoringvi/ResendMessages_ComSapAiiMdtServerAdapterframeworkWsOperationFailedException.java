    ...
    extends JAXBElement<OperationFailedException>
{
    ...
    protected final static QName NAME = new QName("urn:AdapterMessageMonitoringWsd/AdapterMessageMonitoringVi", "resendMessages_com.sap.aii.mdt.server.adapterframework.ws.OperationFailedException");

    public ResendMessages_ComSapAiiMdtServerAdapterframeworkWsOperationFailedException(OperationFailedException value) {
        super(NAME, ((Class) OperationFailedException.class), null, value);
    }

    public ResendMessages_ComSapAiiMdtServerAdapterframeworkWsOperationFailedException() {
