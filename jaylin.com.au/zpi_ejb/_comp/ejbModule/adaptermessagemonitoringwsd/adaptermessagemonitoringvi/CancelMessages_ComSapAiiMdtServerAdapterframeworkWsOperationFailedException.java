    ...
    extends JAXBElement<OperationFailedException>
{
    ...
    protected final static QName NAME = new QName("urn:AdapterMessageMonitoringWsd/AdapterMessageMonitoringVi", "cancelMessages_com.sap.aii.mdt.server.adapterframework.ws.OperationFailedException");

    public CancelMessages_ComSapAiiMdtServerAdapterframeworkWsOperationFailedException(OperationFailedException value) {
        super(NAME, ((Class) OperationFailedException.class), null, value);
    }

    public CancelMessages_ComSapAiiMdtServerAdapterframeworkWsOperationFailedException() {
